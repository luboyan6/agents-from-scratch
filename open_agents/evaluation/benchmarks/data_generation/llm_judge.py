...
from open_agents.core.llm import OpenAgentsLLM
...
class LLMJudgeEvaluator:
    ...
    成员变量:
        EVALUATION_DIMENSIONS: 评估维度列表（类变量）
        llm: LLM实例
        judge_model: 评委模型名称
    """
    ...
    def __init__(
        self,
        llm: Optional[OpenAgentsLLM] = None,
        ...
        """
        # ==================== 成员变量 ====================
        self.llm = llm or OpenAgentsLLM(model=judge_model)  # LLM实例
        self.judge_model = judge_model                       # 评委模型名称
