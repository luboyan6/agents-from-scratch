...
from open_agents.evaluation.benchmarks.gaia.metrics import GAIAMetrics
...
class GAIAEvaluator:
    ...
    def __init__(
        ...
        """
        # ==================== 成员变量 ====================
        self.dataset = dataset or GAIADataset(     # GAIA数据集
            level=level,
            local_data_dir=local_data_dir
        )
        self.metrics = GAIAMetrics()                # 评估指标计算器
        self.level = level                          # 难度级别
        self.strict_mode = strict_mode              # 严格匹配模式
