...
class MCPTool(Tool):
    ...
    使用示例:
        >>> from open_agents.tools.builtin import MCPTool
        >>>
        >>> # 方式1: 使用内置演示服务器
    ...
    def _create_builtin_server(self):
        ...
        try:
            ...
            server = FastMCP("OpenAgents-BuiltinServer")
            ...
            def greet(name: str = "World") -> str:
                """友好问候"""
                return f"Hello, {name}! 欢迎使用 OpenAgents MCP 工具！"
            ...
            def get_system_info() -> dict:
                ...
                return {
                    ...
                    "server_name": "OpenAgents-BuiltinServer",
                    "tools_count": 6
                }
    ...
    def _discover_tools(self):
        """发现MCP服务器提供的所有工具"""
        try:
            from open_agents.protocols.mcp.client import MCPClient
            import asyncio
...
class A2ATool(Tool):
    ...
    使用示例:
        >>> from open_agents.tools.builtin import A2ATool
    ...
    def run(self, parameters: Dict[str, Any]) -> str:
        ...
        """
        try:
            from open_agents.protocols.a2a.implementation import A2AClient, A2A_AVAILABLE
...
class ANPTool(Tool):
    ...
    使用示例:
        >>> from open_agents.tools.builtin import ANPTool
        >>> tool = ANPTool()
        >>> # 注册服务
        >>> result = tool.run({
    ...
    def __init__(self, name: str = "anp", description: str = None, discovery=None, network=None):
        ...
        from open_agents.protocols.anp.implementation import ANPDiscovery, ANPNetwork
    ...
    def run(self, parameters: Dict[str, Any]) -> str:
        ...
        Returns:
            操作结果
        """
        from open_agents.protocols.anp.implementation import ServiceInfo
