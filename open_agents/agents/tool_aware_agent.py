...
该模块实现了 SimpleAgent 的子类，增加了工具调用监听功能。
这使得外部系统可以追踪和记录智能体的工具调用行为。
...
class ToolAwareSimpleAgent(SimpleAgent):
    ...
    成员变量:
        _tool_call_listener: 工具调用监听器回调函数
    """
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # ==================== 成员变量 ====================
        self._tool_call_listener = tool_call_listener  # 工具调用监听器
